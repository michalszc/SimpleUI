 ...
 */
export const black: CSS.DataType.Color = '#000000';

/**
 * Default white colors
 */
export const white: CSS.DataType.Color = '#FFFFFF';

/**
 * Default transparent
 */
export const transparent: CSS.DataType.Color = 'transparent';
